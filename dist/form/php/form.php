    ...
    <div class="container">
      ...
      <div class="w-full border-t border-slate-700 pt-10">
        ...
        <p class="text-center text-xs font-medium text-slate-500">
            Dibuat  <span class="text-pink-500"></span> oleh
            <a href="" target="https://www.instagram.com/anin_rodahad/" class="font-bold text-primary">anin rodahad</a>, Designed By
            <a href="" target="https://www.instagram.com/oracle_indonesia/" class="font-bold text-sky-500">Oracle</a>. <br /><br />
